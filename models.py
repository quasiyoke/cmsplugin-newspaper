...
class NewsFilter(CMSPlugin):
    ...
    number = models.IntegerField(_('number'), default=5, help_text=_('The number of articles that should be displayed.'))
    ...
    def __unicode__(self):
        return u'%s x %d' % (self.template_choices.get(self.news_template, self.news_template), self.number, )
